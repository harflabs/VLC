...
[VLC](https://github.com/harflabs/VLC) is a repository that provides VLC binaries for use in iOS, tvOS, and macOS projects. This repository allows you to easily include VLC's powerful media playback capabilities in your projects via Swift Package Manager.
...
2. Enter the repository URL: `https://github.com/harflabs/VLC`.
...
let package = Package(
  ...
  platforms: [/* */],
  dependencies: [
    .package(url: "https://github.com/harflabs/VLC")
  ],
  targets: [
    .target(
      name: "YourTargetName",
